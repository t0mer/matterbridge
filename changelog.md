...
You'll need to build it yourself. More information about this can be found here: <https://github.com/t0mer/matterbridge#building-with-whatsapp-beta-multidevice-support>

## New features

- whatsappmulti: whatsapp multidevice support added - more info <https://github.com/t0mer/matterbridge#building-with-whatsapp-beta-multidevice-support>
...
New `AutoWebhooks=true` setting, which will automatically use (and create, if they do not exist) webhooks inside specific channels. This only works if the bot has Manage Webhooks permission in bridged channels (global permission or as a channel permission override). Backwards compatibility with channel-specific webhooks. More info [here](https://github.com/t0mer/matterbridge/blob/master/matterbridge.toml.sample#L862).
...
- matrix: Send the display name instead of the user name (matrix) (#1282)  
  Matrix now sends the displayname if set instead of the username. If you want to keep the username, add `UseUsername=true` to your matrix config. <https://github.com/t0mer/matterbridge/wiki/Settings#useusername-1>
- discord: Disable webhook editing (discord) (#1296)  
  Because of issues with ratelimiting of webhook editing, this feature is now disabled. If you have multiple discord channels you bridge, you'll need to add a `webhookURL` to the `[gateway.inout.options]`. See <https://github.com/t0mer/matterbridge/blob/master/matterbridge.toml.sample#L1864-L1870> for an example.
...
- telegram: Support Telegram animated stickers (tgs) format (#1173). See https://github.com/t0mer/matterbridge/wiki/Settings#mediaConverttgs for more info
...
- msteams: new protocol added. Add initial Microsoft Teams support #967
  See https://github.com/t0mer/matterbridge/wiki/MS-Teams-setup for a complete walkthrough
...
- Add scripting (tengo) support for every outgoing message (#806)
  See https://github.com/t0mer/matterbridge/wiki/Settings#tengo and
  https://github.com/t0mer/matterbridge/wiki/Settings#outmessage for more information
- Add tengo support to RemoteNickFormat (#793)
  See https://github.com/t0mer/matterbridge/wiki/Settings#remotenickformat-2
  - Deprecated `Message` under `[tengo]` to `InMessage`

## Enhancements

- general: Forward only user-typing messages if supported by protocol (#832)
- general: updated wiki with all possible settings: https://github.com/t0mer/matterbridge/wiki/Settings
...
- irc: Add verbose IRC joins/parts (ident@host) (#805)
  See https://github.com/t0mer/matterbridge/wiki/Settings#verbosejoinpart
...
If you're still using `legacy tokens` and want to keep using them you'll have to rename `slack` to `slack-legacy` in your configuration. See [wiki](<https://github.com/t0mer/matterbridge/wiki/Section-Slack-(basic)#legacy-configuration>) for more information.

To migrate to the new bot-token based setup you can follow the instructions [here](https://github.com/t0mer/matterbridge/wiki/Slack-bot-setup).
...
- general: remote mediaserver support. See MediaServerDownload and MediaServerUpload in matterbridge.toml.sample
  more information on https://github.com/t0mer/matterbridge/wiki/Mediaserver-setup-%5Badvanced%5D
...
- irc: Add NOPINGNICK option.
  ...
  See https://github.com/t0mer/matterbridge/issues/175 for more information
