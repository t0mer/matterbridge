...
import (
	...
	"github.com/t0mer/matterbridge/gateway/samechannel"
...
func (r *Router) Start() error {
	...
	if len(r.Gateways) == 0 {
		return fmt.Errorf("no [[gateway]] configured. See https://github.com/t0mer/matterbridge/wiki/How-to-create-your-config for more info")
	}
	for _, gw := range r.Gateways {
		r.logger.Infof("Parsing gateway %s", gw.Name)
		if len(gw.Bridges) == 0 {
			return fmt.Errorf("no bridges configured for gateway %s. See https://github.com/t0mer/matterbridge/wiki/How-to-create-your-config for more info", gw.Name)
		}
