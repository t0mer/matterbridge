...
func (b *Bwhatsapp) HandleError(err error) {
	// ignore received invalid data errors. https://github.com/t0mer/matterbridge/issues/843
	// ignore tag 174 errors. https://github.com/t0mer/matterbridge/issues/1094
...
func (b *Bwhatsapp) HandleImageMessage(message whatsapp.ImageMessage) {
	...
	// rename .jfif to .jpg https://github.com/t0mer/matterbridge/issues/1292
	if fileExt[0] == ".jfif" {
		fileExt[0] = ".jpg"
	}

	// rename .jpe to .jpg https://github.com/t0mer/matterbridge/issues/1463
	if fileExt[0] == ".jpe" {
		fileExt[0] = ".jpg"
	}
